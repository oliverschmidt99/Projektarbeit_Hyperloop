...
Im Zustand \frqq Drive\flqq\ wird die Geschwindigkeit durch das Drehrad  \frqq Geschwindigkeit Automatik\flqq\ siehe Abbildung \ref{Controllpanel:img:Controllpanel} durch den Nutzer eingestellt.
