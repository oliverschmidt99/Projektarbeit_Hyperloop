...
Die Datenleitungen
Wenn zwei Leitung für Datenübertragung vorhanden. Für zweiadrige kommunikation können entweder Synchron oder Asynchron kommunikation sein. Fals es Synchron ist, dann muss ein der Leitung ein Clock sein, anstonsten ist es Asynchron und eine Leitung ist der Sender und die andere ist der Empfänger (TX) (Rx). Full Dublex.
